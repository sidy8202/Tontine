...
<head>
    ...
    <!-- <link rel="stylesheet" href="/Tontine/assets/css/compt.css"> -->
    <title>Compte</title>
</head>
    ...
    <div class="container" style="margin-top: 20px;">
        <div class="row border">
            ...
            <div class="col-md border bg-light"> 
                ...
                <div class="row border">
                    <div class="col">
                        <p><i class="fa fa-gear"></i>&nbsp;<a href=""; style="text-decoration: none;color:black">Paramètre</a></p> 
                    </div>
                </div>
                <div class="row border">
                    <div class="col">
                        <p><i class="fa fa-lock"></i>&nbsp;<a href=""; style="text-decoration: none;color:black">Confidentialité</a></p> 
                    </div>
                </div>
                <div class="row border">
                    <div class="col">
                        <p><i class="fa fa-circle-question"></i>&nbsp;<a href=""; style="text-decoration: none;color:black">Aide</a></p> 
                    </div>
                </div>    
            </div>
        </div> 
