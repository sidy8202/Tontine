        ...
        <div class="container">
          <div class="row border" style="background-color: #fdaf8e; margin-top: 10px;">
              ...
              <div class="col" style="margin-top: 30px;">
                  <p><a style="text-decoration: none; color: #fff;" href=""><i class="fa fa-user"></i>&nbsp; <?= @$_SESSION['username']?></a></p>
              </div>
                    ...
                    <div class="row border">
                        <div class="col-md-4 border" style="background-color:#042962; width: 300px; height: 500px;">
                         ...
                         <?php
                            ...
                            //  $resultat = "SELECT utilisateur.prenom_util, utilisateur.nom_util, utilisateur.phone, utilisateur.email,utilisateur.adresse
                            //  FROM utilisateur
                            ...
                            <div class="row">
                              <h3 style="text-align: center; background-color: #E86024;">Liste des membres</h3>
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                      <tr>
                                      <td scope="row"><?php echo $row['nom_util'];?></td>
